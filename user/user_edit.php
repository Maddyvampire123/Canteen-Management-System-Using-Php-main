 ...
 ?>
            ...
            <div class="main-content" >
                <div class="section__content section__content--p30">
                    ...
                    echo "<form name='frmbuy' action='userupdate.php' method='POST'>";
                    echo "<table>
                    <tr align='center'>
                    ...
                    while($row = mysqli_fetch_array($result1)) {
                        ...
                        echo "<tr>";
                        echo "<td>" . $i . "</td>";
                        echo "<td><input type='text' name='User_Id' value='$User_Id' disabled ></td>";
                        echo "<td><input type='text' name='Phone' value='$Phone'></td>";
                        echo "<td><input type='text' name='Mail' value='$Mail'></td>";
                        echo "<td><input type='text' name='Wallet' value='$Wallet'></td>";
                        echo "</tr><input type='text' name='User_Id' value='$User_Id' hidden>";
                        $i++;
                    }
                    echo "</table>";
                    mysqli_close($con);
                    ?>
                    <br>
                    <input type='submit' class='btn btn-success' value='Update' onClick="update(<?php echo $User_Id; ?>)">
