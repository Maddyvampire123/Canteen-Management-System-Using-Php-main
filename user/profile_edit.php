	...
	// echo "$user $balance uploads/$photo $email"; 
            ...
            <div class="main-content" >
                <div class="section__content section__content--p30">
                    ...
                    ?>
                    <table>
                    <form name="frmprof" action="profile_update.php" method="POST">
                    <?php
                    $i=1;
                    ...
                    <tr>
                    <th>First Name</th>
                    <td ><input style="width: 100%;" type="text" name="First_Name" value="<?php echo $row['First_Name'] ;?>"></td>
                    </tr>
                    <tr>
                    <th>Last Name</th>
                    <td ><input style="width: 100%;" type="text" name="Last_Name" value="<?php echo $row['Last_Name'] ;?>"></td>
                    </tr>
                    <tr>
                    <th>Date of Birth</th>
                    <td ><input style="width: 100%;" type="date" name="Dob" value="<?php echo $row['Dob'] ;?>"></td>
                    </tr>
                    <tr>
                    <th>Phone</th>
                    <td ><input style="width: 100%;" type="text" name="Phone" value="<?php echo $row['Phone'] ;?>"></td>
                    </tr>
                    <tr>
                    <th>Mail</th>
                    <td ><input style="width: 100%;" type="email" name="Mail" value="<?php echo $row['Mail'] ;?>"></td>
                    </tr>
                    <?php
                        $i++;
                    }
