 ...
 ?>
            ...
            <div class="main-content" >
                <div class="section__content section__content--p30">
                    ...
                    echo "<form name='pwdform' action='reset.php' method='POST'>";
                    echo "<table>";                       
                    echo "<tr align='center'>";
                    echo "<th > Change Password</th></tr>";
                    echo "<tr align='center'><td><input style='width:100%;' type='Password' name='cpwd' placeholder='Enter Password' Required></td></tr>";
                    echo "<tr align='center' ><td><input style='width:100%;' type='Password' name='pwd1' placeholder='New Password' Required ></td></tr>";
                    echo "<tr align='center' ><td><input style='width:100%;' type='Password' name='pwd2' placeholder='Confirm Password' Required></td></tr>";
